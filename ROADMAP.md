...
| [F-rename](#f-rename) | feature | table-stakes | M | cli, core | now | ✅ | v0.4 | `roadmap rename`: rename a feature id, move its file, and rewrite cross-references so anchors stay consistent. |
